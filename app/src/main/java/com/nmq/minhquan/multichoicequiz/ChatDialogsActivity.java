...
import com.nmq.minhquan.multichoicequiz.Adapter.ChatDialogsAdapters;
import com.nmq.minhquan.multichoicequiz.Common.Common;
import com.nmq.minhquan.multichoicequiz.Holder.QBChatDialogHolder;
    ...
    private void loadChatDialogs(){
        ...
        QBRestChatService.getChatDialogs(null, requestGetBuilder).performAsync(new QBEntityCallback<ArrayList<QBChatDialog>>() {
            ...
            public void onSuccess(ArrayList<QBChatDialog> qbChatDialogs, Bundle bundle) {
                ...
                // Get Message Unread
                QBRestChatService.getTotalUnreadMessagesCount(setIds, QBUnreadMessagesHolder.getInstance().getBundle()).performAsync(
                        new QBEntityCallback<Integer>() {
                            @Override
